...
[![Build Status](https://travis-ci.org/magic-wormhole/magic-wormhole-mailbox-server.svg?branch=master)](https://travis-ci.org/magic-wormhole/magic-wormhole-mailbox-server)
[![Windows Build Status](https://ci.appveyor.com/api/projects/status/mfnn5rsyfnrq576a/branch/master?svg=true)](https://ci.appveyor.com/project/magic-wormhole/magic-wormhole-mailbox-server)
[![codecov.io](https://codecov.io/github/magic-wormhole/magic-wormhole-mailbox-server/coverage.svg?branch=master)](https://codecov.io/github/magic-wormhole/magic-wormhole-mailbox-server?branch=master)
...
[transit-relay](https://github.com/magic-wormhole/magit-wormhole-transit-relay).
